...
| 검수 항목 | 명령 | 결과 |
|---|---|---|
| Stub API 계약 | `npm run test:stub` | 13건 통과 |
| 프론트 단위·통합 테스트 | `npm run test` | 17건 통과 |
...
고정 날짜는 시간이 지나면 D-day와 불일치하므로 한국 날짜 기준 실행 시점으로부터 2일·4일·6일·8일 뒤의 날짜를 계산하도록 수정하고 검증을 추가했다.
