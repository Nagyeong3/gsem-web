...
const graph: ReplacementGraph = {
  items: [
    ...
    { id: 'c1', itemNum: 'XXXXXX-09', itemName: 'C-1장비', businesses: ['다 사업'], status: '단종', depth: 4, position: { x: 680, y: 350 } },
    ...
    { id: 'c2', itemNum: 'XXXXXX-11', itemName: 'C-2장비', businesses: ['가 사업', '다 사업'], status: '사용 중', depth: 5, position: { x: 900, y: 270 } },
    { id: 'd', itemNum: 'XXXXXX-12', itemName: 'D장비', businesses: ['가 사업'], status: '단종', depth: 5, position: { x: 900, y: 405 } },
  ],
  relations: [
